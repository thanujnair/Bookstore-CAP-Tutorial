...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "authorslistview/test/integration/FirstJourney",
    "authorslistview/test/integration/AuthorsListJourney",
    "authorslistview/test/integration/AuthorsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
